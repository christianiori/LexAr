...
async function getTermsFromTEI(xmlPath, maxWords = 50) {
    ...
    const stopwords = new Set([
        // ARTICOLI
        "ὁ", "ἡ", "τό", "οἱ", "αἱ", "τα", "τοῦ", "τῆς", "τοῖς", "ταῖς", "τῶν",
        "ὃ", "ἣ", "ἥ", "ὅς", "ὃς", "ὅν", "ὅς", "ὅτι", "ἥν",

        // PRONOMI PERSONALI (varianti con accenti)
        "ἐγώ", "ἐγὼ", "ἐμοῦ", "ἐμοί", "μοι", "με", "σύ", "σοῦ", "σοι", "σε",
        "ἡμεῖς", "ἡμῶν", "ἡμῖν", "ἡμᾶς", "ὑμεῖς", "ὑμῶν", "ὑμῖν", "ὑμᾶς",
        "αὐτός", "αὐτή", "αὐτό", "αὐτοῦ", "αὐτῆς", "αὐτῷ", "αὐτόν", "αὐτήν",
        "ἐμαυτοῦ", "ἐμαυτῷ", "ἐμαυτὸν", "σεαυτοῦ", "σεαυτῷ", "σεαυτὸν",
        "ἑαυτοῦ", "ἑαυτῷ", "ἑαυτὸν", "ἡμῶν", "ὑμῶν",

        // PRONOMI DIMOSTRATIVI / INTERROGATIVI / RELATIVI
        "οὗτος", "αὕτη", "τοῦτο", "τούτου", "ταύτης", "τούτῳ", "ταύτῃ",
        "ὅς", "ἥ", "ὅ", "ὅτι", "τίς", "τί", "τις", "τινός", "τινὶ", "τινά",
        "ἐκεῖνος", "ἐκείνη", "ἐκεῖνο", "ἐκείνου", "ἐκείνης", "ἐκείνοις",
        "ἄλλος", "ἄλλη", "ἄλλο", "ἑκάτερος", "ἑκάστη", "ἑκάστον",

        // CONGIUNZIONI E PARTICELLE
        "καί", "καὶ", "δέ", "δὲ", "ἀλλά", "ἀλλὰ", "τε", "μέν", "μὲν", "γάρ", "γὰρ",
        "οὐ", "οὐκ", "οὐχ", "οὐχί", "οὔτε", "οὔ", "μή", "μήτε", "μηδέ", "μὴ",
        "ἄν", "ἐάν", "ἐὰν", "ἤ", "εἰ", "ὡς", "ὥς", "ὥστε", "ὅταν", "ἵνα", "ὅτι",
        "οὖν", "ἆρα", "γέ", "γὰρ", "μήν", "μὴν", "τοι", "τοίνυν", "νυν",

        // AVVERBI
        "νῦν", "νυν", "ἤδη", "ἆρα", "γέ", "γὰρ", "οὖν", "τοίνυν", "μήν", "μὴν",
        "τοι", "εἶτα", "ἀμήν", "ἴσως", "τάχα", "ἆρα", "ἔτι", "οὐδέ", "μηδέ",
        "οὕτως", "αὖτε", "ὡς", "ὡσ", "ὥσπερ", "ὅπως", "δεῦρο", "ἐκεῖ", "ἐνθάδε",
        "ταχὺ", "ἤδη", "αὖ", "ποτέ", "παντάπασιν", "ἐντεῦθεν",

        // PREPOSIZIONI
        "ἐν", "εἰς", "ἐκ", "πρός", "πρὸς", "μετά", "μετὰ", "κατά", "κατὰ",
        "ὑπό", "ὑπὸ", "ἀπό", "ἀπὸ", "διά", "διὰ", "ἐπί", "ἐπὶ", "παρά", "παρὰ",
        "ἀντί", "ἀντὶ", "ὑπέρ", "ὑπὲρ", "περὶ", "ἀμφί", "ἀμφὶ", "χωρίς",
        "εἴσω", "ἄνευ", "ἐγγύς", "ἄχρι", "ἕνεκα", "χάριν",

        // TRONCAMENTI COMUNI DI PRONOMI, CONGIUNZIONI E PARTICELLE
